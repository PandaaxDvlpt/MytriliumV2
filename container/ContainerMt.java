package fr.pandaax.mytrilium.container;
...
public class ContainerMt extends Container
{
    ...
    public ContainerMt(InventoryPlayer p_i1812_1_, TileEntityMytriliumFurnace p_i1812_2_)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (p_82846_2_ != 1 && p_82846_2_ != 0)
            {
                ...
                else if (TileEntityMytriliumFurnace.isItemFuel(itemstack1))
                {
