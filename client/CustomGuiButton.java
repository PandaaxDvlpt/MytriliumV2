...
{
    private static final ResourceLocation buttonTextures = new ResourceLocation(Reference.MOD_ID + ":textures/gui/gbuttons.png");

    public CustomGuiButton(int id, int x, int y, int w, int h, String txt)
    {
