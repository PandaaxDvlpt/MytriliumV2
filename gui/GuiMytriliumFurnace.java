...
public class GuiMytriliumFurnace extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
    private static final String __OBFID = "CL_00000758";
    private TileEntityMytriliumFurnace tileFurnace;

    public GuiMytriliumFurnace(InventoryPlayer p_i1091_1_, TileEntityMytriliumFurnace p_i1091_2_)
    {
        super(new ContainerMt(p_i1091_1_, p_i1091_2_));
